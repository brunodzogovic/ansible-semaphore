...
Run the file `latest-version.py` which will pull the latest version from Semaphore UI and embed it in the `.var` file locally for building the adjacent version of the image. 
